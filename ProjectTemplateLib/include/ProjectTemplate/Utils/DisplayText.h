...
constexpr std::string_view terminalOne_Welcome = "Welcome to Terminal One. User log in required. No user passcode found. Generating passcode. New user passcode is: ";
constexpr std::string_view terminalOne_LogIn = "Please log into the terminal. And don't forget your passcode, you will not be provided another. :)";
constexpr std::string_view terminalOne_FireBind = "It appears that the room housing Terminal One is on fire. Please put out the fires. "
...
constexpr std::string_view terminalOne_FireBound = "Sequence bound to the sprinklers successfully. The following sequence will control the sprinklers: ";
